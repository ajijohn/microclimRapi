...
MicroclimAPI <- setRefClass("MicroclimAPI",
                       ...
                       methods = list(
                         apis = function() {
                           ...
                           apis_json = httr::GET(apis_ep, httr::add_headers(Authorization = auth_hdr))
                         ...
                         requests = function() {
                           ...
                           rqsts_json = httr::GET(apis_ep, httr::add_headers(Authorization = auth_hdr))
                           return(rqsts_json)
                         },
                         status = function(requestId) {
                           ...
                           rqst_json = httr::GET(apis_ep,query = list(requestId = requestId),httr::add_headers(Authorization = auth_hdr))
                         ...
                         request = function(mr) {
                           ...
                           rqst_json = httr::POST(apis_ep, body = mr$mreq_list(), httr::add_headers(Authorization = auth_hdr), encode = "json")
                         ...
                         poke = function(requestId) {
                           ...
                           poke = httr::GET(apis_ep,httr::add_headers(Authorization = auth_hdr))
                         ...
                         download = function(requestId,fileName) {
                           ...
                           rqst_file = httr::GET(apis_ep,query = list(requestId = requestId,fileKey=fileName),httr::add_headers(Authorization = auth_hdr))
